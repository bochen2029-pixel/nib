# HANDOFF, 2026-09-04 — superseded, kept as the record

> **This is not the current handoff.** Read `HANDOFF.md` at the repository root, written 2026-09-05
> at 0.10.0. This file is the one that was written on 2026-09-04, when nib was four hours old and
> Stages 0a–0d had just landed, with the addenda that were stacked on it through 1c, 1d and 2. It is
> kept whole because it is the record of how the project started and of what each day believed at
> the time, and because a notebook is not rewritten. Where it and the current handoff disagree, the
> current one is right and this one is history.
